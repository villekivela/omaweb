...
default theme's palette. It is the same file in every theme: the page could redraw it only as a
`data:` URL, and Omaweb's engine shows no icon for one of those.
