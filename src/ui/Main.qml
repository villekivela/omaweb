...
ApplicationWindow {
    ...
    readonly property var callAddressPolicy: webRtcPolicy
    readonly property var engineCallAddressPolicy: engineWebRtcPolicy
        ...
        Item {
            ...
            Item {
                ...
                SettingsPage {
                    ...
                    webRtcPolicy: window.callAddressPolicy
                    engineWebRtcPolicy: window.engineCallAddressPolicy
