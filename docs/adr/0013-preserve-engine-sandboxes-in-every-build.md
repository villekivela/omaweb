...
Ninja, and compiler caching. Development produces a runnable application bundle; signing,
notarization, and DMG distribution remain later work. Omaweb does not target the Mac App Store.
