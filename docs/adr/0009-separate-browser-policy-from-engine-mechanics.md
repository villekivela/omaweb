...
Omaweb core owns Spaces and tab identity, session restoration, Site-permission policy, download
policy and records, history, content-blocking configuration, keyboard commands, and user-facing
...
support allow-once, persistent allow, and block decisions. Private-window permissions expire with
the shared private session.
