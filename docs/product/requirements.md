...
- Quiet text is content, not decoration: a tab's title, a Space's letters, the footer's controls. Whatever a theme names for it, Omaweb holds it to WCAG AA against every surface it is drawn on, and therefore clear of the disabled rendering of ordinary text — a reader must never have to guess whether something is merely quiet or actually unavailable.
