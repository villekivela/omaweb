...
- Developer tools are drawn in the active theme, including the colours source, markup, and stylesheets are read in. The theme names those colours; an inspector Tanto cannot colour is left in the engine's own palette rather than approximated.
